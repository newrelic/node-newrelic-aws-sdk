...
class StreamHandler {
  ...
  /**
   * The identifier for the model that has returned the stream to be processed.
   */
  modelId
  ...
  constructor({ stream, passThroughParams, modelId, onComplete }) {
