...
'use strict'
const { LlmChatCompletionMessage, LlmChatCompletionSummary, BedrockCommand, BedrockResponse } = require('../llm')
...
function getBedrockSpec({ config, commandName }, _shim, _original, _name, args) {
  ...
  return {
    promise: true,
    name: `Llm/${bedrockCommand.modelType}/Bedrock/${commandName}`,
